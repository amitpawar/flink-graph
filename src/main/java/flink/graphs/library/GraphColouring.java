...
public class GraphColouring<K extends Comparable<K> & Serializable>
		implements
	...
	@Override
	public Graph<K, Tuple4<Integer, Integer, Integer, Integer>, NullValue> run(
			Graph<K, Tuple4<Integer, Integer, Integer, Integer>, NullValue> network) {
		// network.getContext().getIdString();
		return network.runVertexCentricIteration(new VertexUpdater<K>(colour,
				network.getContext().getIdString()), new MessagingFunc<K>(
				network.getContext().getIdString()), maxIterations);
	}
	...
	public static final class VertexUpdater<K extends Comparable<K> & Serializable>
		...
		public void updateVertex(K vertexKey,
			...
			if (getSuperstepNumber() == 1) { // DegreeInit1
				if (vertexValue.f3 == -1) {
					Tuple4<Integer, Integer, Integer, Integer> newState = vertexValue
							.copy();
					newState.f1 = UNKNOWN;
					setNewVertexValue(newState);
					// System.out.println("ID " + id + " " +
					// "Update-superstep1 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 == -1) {
					...
					setNewVertexValue(newState);
					// System.out.println("ID " + id + " " +
					// "Update-superstep2 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
				}
			} else if (((getSuperstepNumber() - 3)) % 4 == 0) { // Select
				if (vertexValue.f3 == -1) {
					// System.out.println("ID " + id + " " +
					// "Update-superstep3.1 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
					if (vertexValue.f1.intValue() == UNKNOWN) {
						// System.out.println("ID " + id + " " +
						// "Update-superstep3.2 " + getSuperstepNumber() +
						// " vertexKey " + vertexKey + " vCol " +
						// vertexValue.f0);
						Random r = new Random();
						if (vertexValue.f2.doubleValue() == 0 || true) {// ||
							...
							setNewVertexValue(newState);
							// System.out.println("ID " + id + " " +
							// "Update-superstep3.3 " + getSuperstepNumber() +
							// " vertexKey " + vertexKey + " vCol " +
							// vertexValue.f0);
						}
					}
					// System.out.println("ID " + id + " " +
					// "Update-superstep3 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 == -1) {
					...
					// System.out.println("ID " + id + " " +
					// "Update-superstep4 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 == -1) {
					...
					// System.out.println("ID " + id + " " +
					// "Update-superstep5 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 == -1) {
					...
					// System.out.println("ID " + id + " " +
					// "Update-superstep6 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
				}
			}
		}
		...
		public void sendMessages(K vertexKey,
			...
			if (getSuperstepNumber() == 1) { // DegreeInit1
				if (vertexValue.f3 == -1) {
					...
					// System.out.println("ID " + id + " " + "Send-superstep1 "
					// + getSuperstepNumber() + " vertexKey " + vertexKey +
					// " vCol " + vertexValue.f0);
				}
			} else if (getSuperstepNumber() == 2) { // DegreeInit2
				if (vertexValue.f3 == -1) {
					sendMessageToAllNeighbors(new Long(0));
					// System.out.println("ID " + id + " " + "Send-superstep2 "
					// + getSuperstepNumber() + " vertexKey " + vertexKey +
					// " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 == -1) {
					sendMessageToAllNeighbors(new Long(0));
					// System.out.println("ID " + id + " " +
					// "Send-superstep2.5 " + getSuperstepNumber() +
					// " vertexKey " + vertexKey + " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 == -1) {
					...
					// System.out.println("ID " + id + " " + "Send-superstep3 "
					// + getSuperstepNumber() + " vertexKey " + vertexKey +
					// " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 != -1) {
					if (vertexValue.f1.intValue() == INS
							&& vertexValue.f3.intValue() == getSuperstepNumber()) {
						sendMessageToAllNeighbors(new Long(0));
					}
					// System.out.println("ID " + id + " " + "Send-superstep4 "
					// + getSuperstepNumber() + " vertexKey " + vertexKey +
					// " vCol " + vertexValue.f0);
				}
				...
				if (vertexValue.f3 == -1) {
					...
					// System.out.println("ID " + id + " " + "Send-superstep5 "
					// + getSuperstepNumber() + " vertexKey " + vertexKey +
					// " vCol " + vertexValue.f0);
				}
			} else if (((getSuperstepNumber() - 4)) % 4 == 3) { // DegreeAdj2
				if (vertexValue.f3 == -1) {
					// System.out.println("ID " + id + " " + "Send-superstep6 "
					// + getSuperstepNumber() + " vertexKey " + vertexKey +
					// " vCol " + vertexValue.f0);
					sendMessageToAllNeighbors(new Long(0));
				}
